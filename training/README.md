...
Verifiers-compatible training harness for `rlm.RLM` at depth=1. Designed to plug directly into [`prime-rl`](https://github.com/PrimeIntellect-ai/prime-rl) for end-to-end RL training of RLM policies.
